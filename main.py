...
def Sheet_task5(movies: dict, min_score: int):
    """
...
results3 = Sheet_task5(movies=actor_films, min_score=2)
print(results3.get("message")) if results3.get("message") is not None else None
print(results3.get("movies"))
